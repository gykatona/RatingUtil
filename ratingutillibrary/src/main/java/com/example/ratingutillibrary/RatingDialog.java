...
public class RatingDialog extends DialogFragment {
    ...
    public RatingDialog(String appPackageName,
                        String appName,
        ...
        try {
            close.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    dismiss();
                    RatingDialogTimer.clearSharedPreferences(getActivity());
                    Log.d(TAG, "Clear the shared preferences");
                    RatingDialogTimer.setOptOut(getActivity(), true);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            this.subjectEmail = savedInstanceState.getString("subjectEmail");
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString("subjectEmail", subjectEmail);
    ...
    private void initializeUiFields() {
        // Main Dialog
        mView = View.inflate(getActivity(), R.layout.rating_dialog_message, null);
        tView = View.inflate(getActivity(), R.layout.rating_dialog_title, null);
    ...
    public static class Builder {
         ...
         */
        public Builder enableFeedbackByEmail(String email, String subject) {
        ...
        public RatingDialog build() {
            ...
            return new RatingDialog(appPackageName,
                    appName,
                    headerBackgroundColor,
                    headerTextColor,
                    bodyBackgroundColor,
